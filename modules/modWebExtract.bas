...
Dim db As Database
Dim rs As Recordset
'laatstgespeelde sessie
'aantal teams
' gespeeldtegen


Set db = CurrentDb
Set rs = db.OpenRecordset("select * from tblUitslagen where [ToernooiID] = " & ToernID)
...
Loop
   ...
   BepaalZwitsersIntern = strIndeling
