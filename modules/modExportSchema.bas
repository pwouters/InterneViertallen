...
For teller = 1 To WEDSTRIJDENPERSESSIE * WEDSTRIJD
    ...
    StepIndelingRonde(teller) = StepIndelingRonde(teller) & "/schedule clear " & teller & vbCr
    ...
    For teller = 1 To AANTALTEAMS \ 2
        ...
        End If
            ...
            Else
                If TEAMBYE <> 0 Then
                    If WEDSTRIJD = ENKEL Then
                        StepIndelingRonde(intronde) = StepIndelingRonde(intronde) & ", A" & (teller * 2 - 1) & (teller * 2 - 1) & " " & ByeSpeler1 & " " & ByeSpeler3 & vbCr
                    Else
                        StepIndelingRonde((intronde - 1) * 2 + 1) = StepIndelingRonde((intronde - 1) * 2 + 1) & ", A" & (teller * 2 - 1) & " " & ByeSpeler1 & " " & ByeSpeler3 & vbCr
                        StepIndelingRonde((intronde) * 2) = StepIndelingRonde((intronde) * 2) & ", A" & (teller * 2 - 1) & " " & ByeSpeler3 & " " & ByeSpeler1 & vbCr
                    End If
                 Else
                     If WEDSTRIJD = ENKEL Then
                        StepIndelingRonde(intronde) = StepIndelingRonde(intronde) & ", A" & (teller * 2 - 1) & " " & ThuisSpeler1 & " " & UitSpeler1 & ", " & "A" & (teller * 2) & " " & UitSpeler3 & " " & ThuisSpeler3 & ""
                     Else
                        StepIndelingRonde((intronde - 1) * 2 - 1) = StepIndelingRonde((intronde - 1) * 2 + 1) & ", A" & (teller * 2 - 1) & " " & ThuisSpeler1 & " " & UitSpeler1 & ", " & "A" & (teller * 2) & " " & UitSpeler3 & " " & ThuisSpeler3 & ""
                        StepIndelingRonde((intronde - 1) * 2) = StepIndelingRonde((intronde - 1) * 2) & ", A" & (teller * 2 - 1) & " " & ThuisSpeler1 & " " & UitSpeler3 & ", " & "A" & (teller * 2) & " " & UitSpeler1 & " " & ThuisSpeler3 & ""
                    End If
                End If
            End If
    Next
