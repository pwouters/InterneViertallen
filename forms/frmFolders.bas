        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BorderColor =10921638
                    ForeColor =4210752
                    Name ="bstTemplateFolder"
                    ControlSource ="TemplateFolder"
                    OnMouseDown ="[Event Procedure]"
                    GroupTable =3
                    BottomPadding =150
                    GridlineColor =10921638
                    ...
                    Begin
                        Begin Label
                            ...
                            BorderColor =8355711
                            ForeColor =8355711
                            Name ="lblTemplatefolder"
                            Caption ="KiesTemplate folder"
                            GroupTable =3
                            BottomPadding =150
                            GridlineColor =10921638
                            LayoutCachedLeft =165
...
'Private Sub bstName_MouseDown(ByVal Button As Integer, _
'  ByVal Shift As Integer, ByVal X As Single, ByVal Y As Single)

    ' If right-button clicked
 '   If Button = 1 Then
  '          Dim strFile As String
  '         strFile = GetFileName(strG_File)
  '          If Not strFile = "" Then
   '             Me.bstName = strFile
   '             strG_File = Me.bstName
