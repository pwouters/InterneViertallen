dbMemo "SQL" ="SELECT tbl_1_Uitslagen.Avond, tbl_1_Uitslagen.Wedstrijd, tbl_1_Uitslagen.Teamnr_"
    ...
    "R JOIN qry_1_Uitslagen ON (tbl_1_Uitslagen.Teamnr_Uit = qry_1_Uitslagen.Uitnr) A"
    "ND (tbl_1_Uitslagen.Teamnr_thuis = qry_1_Uitslagen.Thuisnr) AND (tbl_1_Uitslagen"
    ".Wedstrijd = qry_1_Uitslagen.Wedstrijdnr) AND (tbl_1_Uitslagen.Avond = qry_1_Uit"
    "slagen.Sessienr);\015\012"
dbMemo "Connect" =""
